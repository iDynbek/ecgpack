...
contains
  ...
  subroutine MatrixElementsEV_RG_2P(m_k, m_l, mm_k, mm_l, vechLk, vechLl, Pbra, Pket, &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do p=1,n
      do q=p,n
        ...
        drach_deltarkl(p,q)=(0.5_wp*(Glob_CurrEnergy0+Glob_CurrEnergy1)*rmkl(p,q)-temp1-temp2)/temp4
...
!MVkl=MVkl+ME_dWd2(W1,tAk,tAl,inv_tAkl,tvk,tvl,inv_tAkltvl,tvkinv_tAkl,inv_tau3,Skl)/temp1
    ...
    temp1=dXddYd(Glob_dmvM,Glob_dmvM,tvk,tbk,tvl,tbl,tAl,tAk,inv_tAkl,det_tAkl,tau3,tau33,tau333,tau334,inv_tAkltAl,inv_tAkltAk)&
           -V2kl-Glob_CurrEnergy0*Glob_CurrEnergy1*Skl+(Glob_CurrEnergy0+Glob_CurrEnergy1)*Vkl
...
!Evaluation of correlation functions
  ...
  end subroutine MatrixElementsEV_RG_2P
