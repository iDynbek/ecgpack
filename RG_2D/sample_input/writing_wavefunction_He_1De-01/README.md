...
The sample `inout.txt` file in this directory defines a basis of 10 ECG functions for the lowest $^1D^e$ state of the helium atom (assuming infinite nuclear mass). 
