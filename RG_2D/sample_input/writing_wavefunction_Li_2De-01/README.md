...
The sample `inout.txt` file in this directory defines a basis of 100 ECG functions for the lowest $^2D^e$ state of the lithium atom (assuming infinite nuclear mass). 
