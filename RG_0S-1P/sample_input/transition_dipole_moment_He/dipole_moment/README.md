...
This directory contains sample wave function files `wf_state0.txt` and `wf_state1.txt`, corresponding to the initial and final states of the He atom (assuming infinite nuclear mass), respectively.
