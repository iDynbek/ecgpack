...
| History | Lists the energy values that were obtained at each basis size when the basis was being build, as well as the number of optimization steps that were performed (e.g. number of objective function evaluations, number of optimization cycles). |
