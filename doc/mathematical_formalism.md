...
Basic theory, mathematical formalism, and evaluation of the most important matrix elements with all-particle explicitly correlated Gaussians are available in the following references:
