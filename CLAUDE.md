...
Most codes ship with a `sample_input/` subdirectory of worked examples — the four energy codes (`RG_0S`, `RG_1P`, `RG_2D`, `RG_2P`) plus the off-diagonal codes `RG_0S-1P`, `RG_0S-2P`, `RG_1P-1P`, `RG_1P-2D`, `RG_1P-2P`, `RG_2D-2D`, and `RG_2P-2P`. Only `CG_0S`, `RG_0S-2D`, and `RG_2P-2D` currently have no sample inputs. See the Running section below.
