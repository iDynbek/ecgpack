...
The sample `inout.txt` file in this directory defines a basis of 100 ECG functions for the lowest $^3P^o$ state of the beryllium atom (assuming infinite nuclear mass). 
